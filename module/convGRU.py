...
class ConvGRUCell(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, bias=True, normalize=False, selayer=False):
        """
        ...
        if self.normalize:
            self.gamma_norm = nn.LayerNorm([self.hidden_dim, self.height, self.width])
            self.beta_norm = nn.LayerNorm([self.hidden_dim, self.height, self.width])
            self.cc_norm = nn.LayerNorm([self.hidden_dim, self.height, self.width])
    ...
    def forward(self, input_tensor, h_cur):
        ...
        if self.se_layer:
            combined_conv = self.se(combined_conv)
...
class ConvGRU(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
                 batch_first=True, bias=True, return_all_layers=False, normalize=False):
        """

...
class ConvLSTMCell(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, bias, padding=0, dilation=1, normalize=True):
        """
    ...
    def forward(self, input_tensor, cur_state):
        ...
        if self.normalize:
            cc_o = self.o_norm(cc_o)
            c_next = self.c_norm(c_next)
...
class ConvLSTM(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers, padding=0, dilation=1,
                 batch_first=False, bias=True, return_all_layers=False, normalize=False):
        ...
        for i in range(0, self.num_layers):
            ...
            cell_list.append(ConvLSTMCell(input_size=(self.height, self.width),
                                          ...
                                          padding=self.padding,
                                          dilation=self.dilation,
                                          bias=self.bias, normalize=self.normalize))

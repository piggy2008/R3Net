...
from config import msra10k_path, video_train_path, datasets_root
from datasets import ImageFolder, VideoImageFolder
...
def main():
    net = R3Net(motion='LSTM').cuda().train()
...
def train(net, optimizer):
    ...
    while True:
        ...
        for i, data in enumerate(train_loader):
            ...
            loss6_record.update(loss6.data, batch_size)
